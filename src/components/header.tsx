...
export default function Header() {
  return (
    <header className="flex w-full items-center justify-between sm:px-8 md:px-16 lg:px-20 p-4 md:bg-[#4747473f] bg-transparent fixed gap-4 h-20 text-white z-30 bg-blur">
